...
exports.getWeatherByDate = function (date, areaId, callback) {
    Weather.findOne({date: date, area_id: areaId}, callback);
};

exports.update = function (weather, data, callback) {
